...
##                                                                      ##
  ...
  $configuration = {
          ...
          'LIBDIR' => {
                        ...
                        'param_type' => 'directory',
                        'required' => 0,
                        'value' => '/home/jj/Desktop/Bioinformatics/3rd_year/1term/Computational_genomics/Seminars/exercise_04/bin/RepeatMasker-4.1.3/Libraries'
                      },
          'RMBLAST_DIR' => {
          ...
          'TRF_PRGM' => {
                          ...
                          'param_type' => 'program',
                          'required' => 1,
                          'value' => '/home/jj/Desktop/Bioinformatics/3rd_year/1term/Computational_genomics/Seminars/exercise_04/bin/trf'
                        }
        };
