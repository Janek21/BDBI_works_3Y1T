...
Dnorm_df<-data.frame(x=Dnorm$Y[,1], y=Dnorm$Y[,2], Treatment=metadata$treatment, Texpression=rowSums(Xnorm_f), Exp=metadata$exp_label)
...
3 main groups, one untreated and 2 treated groups, wich must have different expression patterns.
