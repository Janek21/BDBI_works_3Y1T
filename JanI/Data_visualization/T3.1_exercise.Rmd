...
```{r Ex1}
```
The first example is dynamic only, the last 3 are interactive (hovering and menu)
...
```{r Ex3}
```
h changes the header size

hr creates a horizontal line

br creates a line jump

p for paragraph

strong is for bold

em (or i) is for italics

code for the codebox

a is to embed a link

center is to center in the page
...
```{r Ex4}
```
A title panel for the title, a sidebar panel for bin sizes and a main panel.
