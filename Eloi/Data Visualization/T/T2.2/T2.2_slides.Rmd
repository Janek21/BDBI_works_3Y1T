...
ggplot(data[data$expressed,], aes(tissue)) + geom_bar() + theme_bw() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 8)) 
...
ggplot(data, aes(tissue, median_expression)) + 
  geom_boxplot() + 
  geom_point(data = data_gene, aes(tissue, median_expression), color = "red") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1, size = 8)) +  
  scale_y_log10()
...
ggplot(data_brain, aes(gene_chr,median_expression, colour = median_expression > 20000)) +
  geom_point() +
  labs(title = "Expression of Genes by Chromosome",  x = "Chromosome", y = "Median Expression", colour = "Expression > 20000") + 
  theme(
    axis.text.x = element_text(hjust = 1, size = 5),  
    axis.text.y = element_text(size = 5),
    plot.title = element_text(hjust = 0.5, size = 10, face = "bold"),
    axis.title = element_text(size = 9),  # Mida més petita dels títols dels eixos
    axis.text = element_text(size = 8),  # Mida més petita del text dels eixos
    legend.title = element_text(size = 9),  # Mida més petita del títol de la llegenda
