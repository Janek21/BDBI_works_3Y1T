...
# Output
my_output <- paste("./busco/SRR7548448/SRR7548448_k63_contigs/","busco_figure.png",sep="/") 
my_width <- 20
my_height <- 15
my_unit <- "cm"
...
my_species <- c('SRR7548448_k63_contigs', 'SRR7548448_k63_contigs', 'SRR7548448_k63_contigs', 'SRR7548448_k63_contigs')
...
my_percentage <- c(12.1, 0.1, 13.2, 74.6)
my_values <- c(258, 2, 282, 1595)
