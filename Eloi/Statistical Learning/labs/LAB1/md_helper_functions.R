...
fit_mean_difference <- function(train){
  ...
  # extact the means
  mean_pos <- data.frame(x1 = train_means$x1[train_means$y == 1],x2 =train_means$x2[train_means$y == 1])
  mean_neg <- data.frame(x1 = train_means$x1[train_means$y == -1],x2 =train_means$x2[train_means$y == -1])
